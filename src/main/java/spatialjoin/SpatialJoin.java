...
/**
 * Answer for Question 6 which filters the polygons which completely fall inside a query windows provided
 CHECKING AGAINST MULTIPLE QUERY WINDOWS. LOOPING THE RANGE FUNCTION.
 */
public class SpatialJoin {
    ...
    private static boolean spatialJoinHelper(String rectanglesFilePath, String queryWindowFilePath,
        ...
        try {
            ...
            for(Rectangle rxy:query){
                for(Rectangle rxy:rectangles){
